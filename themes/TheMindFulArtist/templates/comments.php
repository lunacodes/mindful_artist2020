<?php
 ...
 if (have_comments()) : ?>
  <section id="comments"><a name="commentanchor"></a>
    <h3><?php printf(_n('One Response to &ldquo;%2$s&rdquo;', 'Responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?></h3>
